...
- `src/index.test.ts` — A pure module produces a fixed-size grid with indestructible border/pillar walls, a scattering of destructible walls, and open floor tiles, verifiable by unit tests. (EPIC-1-2)
- `src/index.ts` — A pure module produces a fixed-size grid with indestructible border/pillar walls, a scattering of destructible walls, and open floor tiles, verifiable by unit tests. (EPIC-1-2)
...
- EPIC-1-4 Implement bomb placement and explosion mechanics — in_progress
